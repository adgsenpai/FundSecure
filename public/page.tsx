      ...
      <div id="signup" className="py-16 bg-green-500">
        <div className="container mx-auto px-5 text-center">
          ...
          <div className="mt-8">
            <a
              href="/signup"
              className="rounded bg-white px-6 py-3 text-sm font-semibold text-green-500 shadow hover:bg-green-100 transition-colors"
            >
              Sign Up Now
            </a>
          </div>
...
const features = [
  {
    ...
    demo: (
      <div className="flex items-center justify-center">
        <img alt="Interledger Payments" src="/interledger-logo.svg"/>
      </div>
    ),
  },
  {
    ...
    demo: (
      <div className="flex items-center justify-center">
        <img alt="TigerBeetleDB Ledger" src="/tigerbeetle-logo.png"/>
      </div>
    ),
  },
  {
    ...
    demo: (
      <div className="flex items-center justify-center">
        <img alt="Anonymous Transactions" src="/wallet-solid.svg"/>
      </div>
    ),
  },
  {
    ...
    demo: (
      <div className="flex items-center justify-center">
        <img alt="Scalable Microservices" src="/docker-logo.png"/>
      </div>
    ),
  },
  {
    ...
    demo: (
      <div className="flex items-center justify-center">
        <img alt="Rafiki Wallet" src="/rafiki-wallet.jpg"/>
      </div>
    ),
  },
  {
    ...
    demo: (
      <div className="flex items-center justify-center">
        <img alt="Prisma PostgreSQL" src="/prisma-logo.svg"/>
      </div>
    ),
  },
];